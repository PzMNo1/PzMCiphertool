...
CREATE INDEX idx_api_router_keys_email ON api_router_keys(email);
CREATE INDEX idx_api_router_keys_hash ON api_router_keys(key_hash);
...
CREATE INDEX idx_api_router_usage_email_time ON api_router_usage_logs(email, created_at);
CREATE INDEX idx_api_router_usage_key_time ON api_router_usage_logs(key_id, created_at);
...
CREATE INDEX idx_api_router_ledger_email_time ON api_router_ledger(email, created_at);
...
CREATE INDEX idx_api_router_channels_enabled ON api_router_channels(enabled, priority);
CREATE INDEX idx_api_router_channels_circuit ON api_router_channels(enabled, circuit_state, circuit_disabled_until);
...
CREATE INDEX idx_api_router_model_prices_match ON api_router_model_prices(enabled, priority, model_pattern);
CREATE INDEX idx_api_router_model_prices_provider ON api_router_model_prices(provider, channel_id);
...
CREATE INDEX idx_api_router_redeem_codes_enabled ON api_router_redeem_codes(enabled, expires_at);
...
CREATE UNIQUE INDEX idx_api_router_redeem_once ON api_router_redeem_redemptions(code, email);
CREATE INDEX idx_api_router_redeem_email_time ON api_router_redeem_redemptions(email, created_at);
...
CREATE INDEX idx_api_router_orders_email_time ON api_router_orders(email, created_at);
CREATE INDEX idx_api_router_orders_status ON api_router_orders(status, created_at);
CREATE INDEX idx_api_router_orders_idempotency ON api_router_orders(email, idempotency_key);
...
CREATE INDEX idx_api_router_payment_callbacks_order ON api_router_payment_callbacks(order_id, created_at);
CREATE INDEX idx_api_router_payment_callbacks_trade ON api_router_payment_callbacks(pay_method, external_trade_no);
...
CREATE INDEX idx_agent_runs_email_updated ON agent_runs(email, updated_at);
CREATE INDEX idx_agent_runs_email_chat ON agent_runs(email, chat_id, updated_at);
...
CREATE INDEX idx_agent_run_events_run_ts ON agent_run_events(email, run_id, ts);
CREATE INDEX idx_agent_run_events_type ON agent_run_events(email, event_type, ts);
