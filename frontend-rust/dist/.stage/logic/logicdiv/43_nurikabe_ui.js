(function () {
    ...
    window.logicWorkspaceHTMLs.push(window.LogicUI.workspace('nurikabe-workspace', 'nurikabe-layout',
        ...
        window.LogicUI.statsPanel('nurikabe', { countLabel: '解记录数', timeLabel: 'AI thinking耗时', accent: '#00e5ff' }) +
    ...
    document.addEventListener('keydown', e => {
        if (window.LogicUI?.shouldIgnoreGlobalKeydown?.(e, 'nurikabe-workspace') || !sel) return;
