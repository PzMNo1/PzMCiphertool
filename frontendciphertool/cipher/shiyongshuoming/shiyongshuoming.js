(function () {
  const GUIDE_SETS = {
    ...
    agent: {
      ...
      steps: [
        {
          selector: '#agent-deliverable-select',
          title: '选择交付物',
          body: '先选择你要的最终形态：研报、论文、文章或白皮书。Agent 会按这个方向组织标题、结构、证据和语气。'
        },
        {
          selector: '#agent-style-select',
          title: '确定写作风格',
          body: '风格控制文章的味道。编辑风格更锋利，学术风格更克制，咨询风格更像研报，杂志风格更适合长文。'
        },
        {
          selector: '.agent-segmented',
          title: '设置质量档',
          body: '快写适合快速成稿，深研适合完整论证，出版适合更强结构和语言完成度。这里是写作倾向，不是固定门槛。'
        },
        {
          selector: '#attachment-add-btn',
          title: '按需导入材料',
          body: '可以导入文件、目录或聊天记录。Agent 会优先阅读你的材料，再把它们融入正文，而不是只做摘要。'
        },
        {
          selector: '#user-input',
          title: '写清真实目标',
          body: '直接描述主题、读者、立场、长度和必须覆盖的角度。比如“写一篇面向投资人的机器人产业深度研报，要有判断、有数据、有风险”。'
        },
        {
          selector: '#send-message',
          title: '发送后直接成稿',
          body: '当前是单次成稿模式：内部过程不会展开给你。结果应是一篇完整、可读、有风格的正文。'
        }
      ]
    }
  };
