...
${rightHTML}
    ...
    function isTypingTarget(target) {
        ...
        return ['INPUT', 'TEXTAREA', 'SELECT'].includes(el.tagName) ||
            ...
            Boolean(el.closest && el.closest('[contenteditable="true"]'));
    }
    ...
    function isWorkspaceVisible(workspaceId) {
        ...
        return style.display !== 'none' &&
            ...
            workspace.getClientRects().length > 0;
    }

    function shouldIgnoreGlobalKeydown(event, workspaceId) {
        return !isWorkspaceVisible(workspaceId) ||
            isTypingTarget(event?.target || document.activeElement);
    }
