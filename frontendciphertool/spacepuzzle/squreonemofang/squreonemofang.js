(function () {
    ...
    function getWorkspaceHTML() {
        ...
        return `<div id="squreonemofang-workspace" class="space-workspace" style="display:none;gap:2rem;flex-wrap:wrap;align-items:flex-start;">
            ...
            <div class="grid-container card squareone-panel">
