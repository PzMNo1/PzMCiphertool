(function () {
    ...
    function getSlidingPuzzleHTML() {
        ...
        return `
                <div id="number-huarong-workspace" class="space-workspace" style="display:none;gap:2rem;flex-wrap:wrap;align-items:flex-start;">
                    ...
                    <div class="grid-container card space-sliding-panel">
