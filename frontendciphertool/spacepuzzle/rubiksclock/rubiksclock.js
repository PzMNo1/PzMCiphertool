(function () {
    ...
    function getWorkspaceHTML() {
        ...
        return `<div id="rubiksclock-workspace" class="space-workspace" style="display:none;gap:2rem;flex-wrap:wrap;align-items:flex-start;">
            ...
            <div class="grid-container card rubiks-clock-panel">
