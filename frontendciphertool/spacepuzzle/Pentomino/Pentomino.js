(function () {
    ...
    function getWorkspaceHTML() {
        return `<div id="pentomino-workspace" class="space-workspace" style="display:none;gap:2rem;flex-wrap:wrap;align-items:flex-start;">
            ...
            <div class="grid-container card pentomino-panel">
